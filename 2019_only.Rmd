...
biomass.YM <- totaL_density %>%
  ...
  ggplot(., aes(x = as.factor(YEarMonth), y = monthlyMean, group = 1)) +
...
richness.YM <- dailyDesc %>% 
  ...
  ggplot(., aes(x = as.factor(YEarMonth), y = monthlyRichness, group = 1)) +
  geom_point(size = 1, aes(col = season)) +
  #geom_line(size = 0.5) +
  geom_errorbar(aes(col = season, ymin = monthlyRichness - monthlyRichnessSE, ymax = monthlyRichness + monthlyRichnessSE), width=0.2) +
  xlab("Months") +
  ylab("Richness") + 
  labs(col = "Season") +
...
evenness.YM <- dailyDesc %>% 
  ...
  ggplot(., aes(x = as.factor(YEarMonth), y = monthlyEvenness, group = 1)) +
  geom_point(size = 1, aes(col = season)) +
  #geom_line(size = 0.5) +
  geom_errorbar(aes(col = season,ymin = monthlyEvenness - monthlyEvennessSE, ymax = monthlyEvenness + monthlyEvennessSE), width=0.2) + 
  xlab("Months") +
  ylab("J'") +
  labs(col = "Season") +
...
shannon.YM <- dailyDesc %>%
  ...
  ggplot(., aes(x = as.factor(YEarMonth), y = (monthlyshannon), group = 1)) +
  geom_point(size = 1, aes(col = season)) +
  #geom_line(size = 0.5) +
  geom_errorbar(aes(col = season, ymin = monthlyshannon - monthlyshannonSE, ymax = monthlyshannon + monthlyshannonSE), width=0.2) +
  xlab("Months") +
  ylab("H'") +
  #labs(col = "Season") +
