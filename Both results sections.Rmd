...
rich <- dailydesc_filter %>% 
  ...
  geom_point() +
#  geom_line() +
  geom_errorbar(aes(ymin = mean_S - se_cells, ymax = mean_S + se_cells), width=0.2) +
  xlab("Months") +
  ylab("Richness") + 
  labs(fill = "Site") +
#  ggtitle("") +
...
even <- dailydesc_filter %>% 
  ...
  geom_point() +
#  geom_line() +
  geom_errorbar(aes(ymin = mean_J - se_cells, ymax = mean_J + se_cells), width=0.2) +
  xlab("Months") +
  ylab("J'") + 
  labs(fill = "Site") +
#  ggtitle("") +
...
shan <- dailydesc_filter %>% 
  ...
  geom_point() +
#  geom_line() +
  geom_errorbar(aes(ymin = mean_shannon - se_cells, ymax = mean_shannon + se_cells), width=0.2) +
  xlab("Months") +
  ylab("H'") + 
  labs(fill = "Site") +
#  ggtitle("") +
...
# Use SE (where some errorbars do not overlap but pvalue isnt significant)
