...
ggplot(data = count_diff, aes(x = group1, y = group2, col = p.adj)) +
...
count_vs_cells <- lm(log10(count_times) ~ log10(totalCells) * months, data = daily_counts)

summary(count_vs_cells)



correl <- cor.test(daily_counts$count_times, log10(daily_counts$totalCells), method = "spearman")
summary(correl)

ggscatter(correl, x = "mpg", y = "wt", 
...
```{r}
# NMDS plot made (on monthly averaged level)
# ANOSIM to show differences between years
# ANOSIM to show differences between months
```
